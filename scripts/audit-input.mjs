...
for (const contract of [
  ...
  'normalizeValidationState(validation)',
  'var(--input-background-default)',
  'var(--input-border-error)',
  'var(--input-border-warning)',
  'var(--input-border-success)',
  'var(--effect-validation-error)',
  'var(--effect-validation-warning)',
  'var(--effect-validation-success)',
  'var(--effect-focused)',
...
const tokenNames = [
  ...
  ...["default", "hover", "focus", "error", "warning", "success", "invalid", "valid", "disabled"].map((state) => `--input-border-${state}`),
  "--input-text-default",
  "--input-text-disabled",
